    ...
    <div className="mt-12 space-y-12 text-slate-700">
      ...
      <section className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-2">
          ...
          Como usar a Calculadora para Nossos Filhos - AJF
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex gap-2">
                ...
                descubra quanto tempo levará para atingir a meta financeira mantendo um aporte constante.
              </li>
              <li className="flex gap-2">
                <span className="font-medium text-slate-900">Calcular aporte:</span>
                descubra quanto precisa investir mensalmente para chegar ao objetivo em uma data específica.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><span className="font-medium">Valor Inicial:</span> Quanto você já tem guardado para seu filho hoje.</li>
              <li><span className="font-medium">Taxa de Juros:</span> A rentabilidade esperada da carteira de investimentos.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-slate-50 p-6 rounded-lg border-l-4 border-blue-800">
            ...
            <p className="text-sm text-slate-600 mb-4">Ideal se você já definiu um valor mensal confortável para investir e quer saber quando seu filho terá a independência financeira.</p>
            <ul className="text-sm list-disc list-inside text-slate-600">
              <li>Visualiza o poder dos juros no longo prazo (10, 15, 20 anos).</li>
              <li>Mostra a evolução anual do patrimônio da criança.</li>
            </ul>
          </div>
          <div className="bg-slate-50 p-6 rounded-lg border-l-4 border-sky-600">
            ...
            <p className="text-sm text-slate-600 mb-4">Ideal se você tem uma meta de data (ex: quando o filho fizer 18 ou 21 anos) e precisa saber quanto poupar hoje.</p>
            <ul className="text-sm list-disc list-inside text-slate-600">
              <li>Define metas claras de economia mensal familiar.</li>
              <li>Ajuda no planejamento de faculdade ou primeiro imóvel.</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-2 items-start text-sm text-slate-300">
              ...
              <p>Os cálculos são brutos e nominais. Não descontam inflação ou Imposto de Renda, que variam conforme o investimento escolhido para o futuro dos filhos.</p>
            </div>
          </div>
        </div>
      </section>
